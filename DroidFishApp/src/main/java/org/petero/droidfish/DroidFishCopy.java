...
public class DroidFishCopy extends Activity
...

        {
            ...
            addAction(new UIAction() {
                ...
                public void run() {
                    ...
                    Intent i;
                    if (currFT == FT_PGN) {
                        i = new Intent(DroidFishCopy.this, EditPGNLoad.class);
                        ...
                        i = new Intent(DroidFishCopy.this, LoadScid.class);
                        i.setAction("org.petero.droidfish.loadScidPrevGame");
                        i.putExtra("org.petero.droidfish.pathname", currPathName);
                        startActivityForResult(i, RESULT_LOAD_PGN);
                    } else if (currFT == FT_FEN) {
                        i = new Intent(DroidFishCopy.this, LoadFEN.class);
...
//        cb.setOnTouchListener(cbpListener);
    ...
    private void handleDrawerSelection(DrawerItemId id) {
        ...
        case EDIT_BOARD:
            ...
            break;
        case SETTINGS: {
            Intent i = new Intent(DroidFishCopy.this, Preferences.class);
    ...
    private void startEditBoard(String fen) {
        Intent i = new Intent(DroidFishCopy.this, EditBoard.class);
        i.setAction(fen);
        ...
        case RESULT_SELECT_SCID:
            if (resultCode == RESULT_OK) {
                ...
                if (pathName != null) {
                    ...
                    editor.apply();
                    Intent i = new Intent(DroidFishCopy.this, LoadScid.class);
    ...
    private class EloStrengthSetter {
        ...
        public Dialog getDialog() {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DroidFishCopy.this);
            builder.setTitle(R.string.set_engine_strength);
            View content = View.inflate(DroidFishCopy.this, R.layout.set_strength, null);
    ...
    private void editHeaders() {
        ...
        View content = View.inflate(DroidFishCopy.this, R.layout.edit_headers, null);
        builder.setView(content);
    ...
    private void editComments() {
        ...
        View content = View.inflate(DroidFishCopy.this, R.layout.edit_comments, null);
        builder.setView(content);
    ...
    private class MultiPVSet {
        ...
        public void multiPVDialog(int numPV, int maxPV0) {
            ...
            View content = View.inflate(DroidFishCopy.this, R.layout.num_variations, null);
            builder.setView(content);
    ...
    private void setEngineOptions() {
        Intent i = new Intent(DroidFishCopy.this, EditOptions.class);
        UCIOptions uciOpts = ctrl.getUCIOptions();
        if (uciOpts != null) {
    ...
    private void savePGNToFile(String pathName) {
        ...
        editor.apply();
        Intent i = new Intent(DroidFishCopy.this, EditPGNSave.class);
    ...
    private void loadPGNFromFile(String pathName, boolean updateCurrFile) {
        ...
        Intent i = new Intent(DroidFishCopy.this, EditPGNLoad.class);
    ...
    private void loadFENFromFile(String pathName) {
        ...
        editor.apply();
        Intent i = new Intent(DroidFishCopy.this, LoadFEN.class);
